...
exports.updatePayment = exports.updateJob = exports.updateInvoice = exports.unlinkResource = exports.logoutUser = exports.loginUser = exports.getUnpaidInvoices = exports.getPaymentLedger = exports.getAllJobs = exports.deletePayment = exports.deleteJob = exports.deleteInvoice = exports.createPayment = exports.createNewUser = exports.createJob = exports.createInvoice = void 0;
...
// JOBS
var getAllJobs = exports.getAllJobs = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alert.showAlert)('error', "Error Fetching Jobs");
        case 13:
        case "end":
  ...
  return function getAllJobs() {
    return _ref.apply(this, arguments);
  };
}();
var createJob = exports.createJob = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(jobID, type, description, jobPO) {
    var response;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (response.data.success) {
            (0, _alert.showAlert)('success', 'Job Successfully Created');
...
var updateJob = exports.updateJob = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id, jobID, type, description, jobPO) {
    var response;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://localhost:3000/api/v2/mundial/jobs/".concat(id),
            data: {
              jobID: jobID,
              type: type,
              description: description,
        ...
        case 3:
          ...
          if (response.data.success) {
            (0, _alert.showAlert)('success', 'Job Successfully Updated');
            window.setTimeout(function () {
  ...
  return function updateJob(_x5, _x6, _x7, _x8, _x9) {
...
var deleteJob = exports.deleteJob = /*#__PURE__*/function () {
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          if (response.status === 204) {
            (0, _alert.showAlert)('success', 'Job Successfully Deleted');
            window.setTimeout(function () {
              location.assign('/jobs/view');
            }, 2000);
          }
  ...
  return function deleteJob(_x10) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          return _context5.abrupt("return", result.data.invoices);
        case 6:
          ;
          _context5.next = 13;
          break;
        case 9:
          ...
          (0, _alert.showAlert)('error', "Error Fetching Invoices");
        case 13:
        case "end":
...
var createInvoice = exports.createInvoice = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(invoiceNumber, description, salesValue, spentValue, job, invoiceClass, witholdingTaxPercent) {
    var response;
  ...
  return function createInvoice(_x11, _x12, _x13, _x14, _x15, _x16, _x17) {
...
var updatePayment = exports.updatePayment = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(id, tag, details, amount, date, invoices, invStatus) {
    var response;
...
var getPaymentLedger = exports.getPaymentLedger = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(payid) {
    var response;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://localhost:3000/api/v2/mundial/payments/".concat(payid, "/ledger")
          });
        case 3:
...
var unlinkResource = exports.unlinkResource = /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(id, payid) {
    var response;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 7:
          ...
          console.log(_context12.t0.response.data.message);
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 3:
          ...
          if (response.status === 204) {
            (0, _alert.showAlert)('success', 'Payment Successfully Deleted');
            window.setTimeout(function () {
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', _context14.t0.response.data.message);
        case 10:
        case "end":
...
var loginUser = exports.loginUser = /*#__PURE__*/function () {
  var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(username, password) {
    var response;
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', _context15.t0.response.data.message);
        case 10:
        case "end":
  ...
  return function loginUser(_x51, _x52) {
...
var removePayment = document.querySelector('.delete-resource-payment');
var postPayment = document.querySelector('.create-resource-payment');

// JOBS 
var job = document.querySelector('.jobs');
var postJob = document.querySelector('.create-resource-job');
var modifyJob = document.querySelector('.modify-resource-job');
var removeJob = document.querySelector('.delete-resource-job');

// USERS
var createNewUserRecord = document.querySelector('.form--signup');
var loginUserDetails = document.querySelector('.form--login');
var logUserOut = document.querySelector('.logout');
...
;
if (postJob) {
  postJob.addEventListener('submit', function (event) {
    event.preventDefault();
    var jobid = document.getElementById('jobid').value;
    var description = document.getElementById('desc').value;
    var jobtype = document.getElementById('jobtype').value;
    var jobpo = document.getElementById('podoc').value;
    (0, _processData.createJob)(jobid, jobtype, description, jobpo);
  });
}
;
if (modifyJob) {
  modifyJob.addEventListener('submit', function (event) {
    event.preventDefault();
    var jobid = document.getElementById('jobid').value;
    var description = document.getElementById('desc').value;
    var po = document.getElementById('podoc').value;
    var type = document.getElementById('jobtype').value;
    var id = document.getElementById('docid').value;
    (0, _processData.updateJob)(id, jobid, type, description, po);
  });
}
;
if (removeJob) {
...
if (postInvoice) {
  postInvoice.addEventListener('submit', function (event) {
    event.preventDefault();
    ...
    (0, _processData.createInvoice)(invoiceNo, description, salesval, costval, job, invclass, whtpercent);
  });
}
;
if (modifyInvoice) {
...
if (postPayment) {
  ...
  if (invoiceSelection) {
    ...
    (0, _processData.getUnpaidInvoices)().then(function (data) {
      if (data !== undefined) {
        var x = 0;
  ...
  // SECTION 2
  postPayment.addEventListener('submit', function (event) {
    event.preventDefault();
...
if (modifyPayment) {
  ...
  modifyPayment.addEventListener('submit', function (event) {
    ...
    var docid = document.getElementById('docid').value;
    // PROCESS DATA FOR ANY INVOICE TO BE ATTACHED
    var checkditem = document.querySelectorAll('input[name="invoice"]:checked');
    var checkedInvoiceValues = [];
    checkditem.forEach(function (item) {
...
if (createNewUserRecord) {
  createNewUserRecord.addEventListener('submit', function (event) {
    event.preventDefault();
...
;
if (loginUserDetails) {
  loginUserDetails.addEventListener('submit', function (event) {
    event.preventDefault();
    var username = document.getElementById('username').value;
    var password = document.getElementById('passwd').value;
    (0, _processData.loginUser)(username, password);
  });
}
;
if (logUserOut) {
  logUserOut.addEventListener('click', _processData.logoutUser);
}
;
