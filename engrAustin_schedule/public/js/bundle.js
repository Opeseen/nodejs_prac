...
exports.updateInvoice = exports.getAllJobs = void 0;
...
var updateInvoice = exports.updateInvoice = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id, invoiceNumber, invoiceDescription, invoiceAppliedToSalesValue, spentOnProject, job, invoiceClass, witholdingTaxPercent) {
    var resource;
  ...
  return function updateInvoice(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8) {
...
;
if (invoiceDetails) invoiceDetails.addEventListener('submit', function (event) {
