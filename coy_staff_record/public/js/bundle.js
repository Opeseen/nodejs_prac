...
exports.processUpdatedEmployeeRecord = exports.fetchAllPayGroup = void 0;
...
// Employees Section
var processUpdatedEmployeeRecord = exports.processUpdatedEmployeeRecord = /*#__PURE__*/function () {
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PUT',
            url: "http://localhost:8080/api/mun/v1/employee/".concat(id),
            data: {
              firstname: firstname,
              lastname: lastname,
              phone: phone,
  ...
  return function processUpdatedEmployeeRecord(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9) {
...
if (updatedEmployeeRecord) {
  updatedEmployeeRecord.addEventListener('submit', function (event) {
    ...
    (0, _processData.processUpdatedEmployeeRecord)(id, firstname, lastname, phone, email, address, state, city, nationality);
  });
}
;
