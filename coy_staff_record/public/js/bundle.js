    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          return _context2.abrupt("return", result.data.details);
        case 6:
          ;
          _context2.next = 12;
          break;
...
var payGroupPopUp = document.querySelector('.PopupModifyEmployeePayGroup');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "54246" + '/');
